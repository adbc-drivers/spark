...
const logSinkEnvVar = "ADBC_DRIVER_SPARK_LOG_SINK"
...
func initLoggingFromEnv(db adbc.DatabaseLogging) {
	...
	case "tempfile":
		...
		f, err := os.CreateTemp("", "adbc-spark.*.log")
		if err == nil {
			sink = f
		} else {
			fmt.Fprintf(os.Stderr, "[spark] could not open temporary log file: %v", err)
		}
	}
