...
import (
	...
	"github.com/adbc-drivers/spark/go/connectclient/sql/utils"
	"github.com/apache/arrow-go/v18/arrow"

	"github.com/adbc-drivers/spark/go/connectclient/sql/column"

	"github.com/adbc-drivers/spark/go/connectclient/sql/types"
...
type DataFrame interface {
	...
	// ExceptAll is similar to Subtract but does not perform the distinct operation.
	...
	// GroupBy groups the DataFrame by the specified columns so that the aggregation
	...
	// according to the matching columns. If columns are missing, it will throw an error.
