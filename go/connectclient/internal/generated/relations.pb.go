...
func (x *Relation) GetNearestByJoin() *NearestByJoin {
	if x != nil {
		if x, ok := x.RelType.(*Relation_NearestByJoin); ok {
			return x.NearestByJoin
		}
	}
	return nil
}

func (x *Relation) GetZip() *Zip {
	if x != nil {
		if x, ok := x.RelType.(*Relation_Zip); ok {
			return x.Zip
		}
	}
	return nil
...
type Relation_NearestByJoin struct {
	NearestByJoin *NearestByJoin `protobuf:"bytes,47,opt,name=nearest_by_join,json=nearestByJoin,proto3,oneof"`
}

type Relation_Zip struct {
	Zip *Zip `protobuf:"bytes,48,opt,name=zip,proto3,oneof"`
}
...
func (*Relation_NearestByJoin) isRelation_RelType() {}

func (*Relation_Zip) isRelation_RelType() {}
...
type NearestByJoin struct {
	...
	RankingExpression *Expression `protobuf:"bytes,3,opt,name=ranking_expression,json=rankingExpression,proto3" json:"ranking_expression,omitempty"`
	// (Required) Maximum number of matches per left row. Must be between 1 and 100000.
	NumResults int32 `protobuf:"varint,4,opt,name=num_results,json=numResults,proto3" json:"num_results,omitempty"`
...
func (x *NearestByJoin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NearestByJoin) ProtoMessage() {}

func (x *NearestByJoin) ProtoReflect() protoreflect.Message {
	mi := &file_spark_connect_relations_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NearestByJoin.ProtoReflect.Descriptor instead.
func (*NearestByJoin) Descriptor() ([]byte, []int) {
	return file_spark_connect_relations_proto_rawDescGZIP(), []int{64}
}

func (x *NearestByJoin) GetLeft() *Relation {
	if x != nil {
		return x.Left
	}
	return nil
...
func (x *NearestByJoin) GetRight() *Relation {
	if x != nil {
		return x.Right
	}
	return nil
...
func (x *NearestByJoin) GetRankingExpression() *Expression {
	if x != nil {
...
func (x *NearestByJoin) GetNumResults() int32 {
	if x != nil {
		return x.NumResults
	}
	return 0
...
func (x *NearestByJoin) GetJoinType() string {
	if x != nil {
		return x.JoinType
	}
	return ""
...
func (x *NearestByJoin) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
func (x *NearestByJoin) GetDirection() string {
	if x != nil {
		return x.Direction
	}
	return ""
...
func (*Zip) Descriptor() ([]byte, []int) {
	return file_spark_connect_relations_proto_rawDescGZIP(), []int{65}
}

func (x *Zip) GetLeft() *Relation {
	if x != nil {
		return x.Left
	}
	return nil
...
func (x *WithColumnsRenamed_Rename) Reset() {
	*x = WithColumnsRenamed_Rename{}
	mi := &file_spark_connect_relations_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Unpivot_Values) Reset() {
	*x = Unpivot_Values{}
	mi := &file_spark_connect_relations_proto_msgTypes[83]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_spark_connect_relations_proto_rawDesc = "" +
	...
	"\x10relation_changes\x18. \x01(\v2\x1e.spark.connect.RelationChangesH\x00R\x0frelationChanges\x12F\n" +
	"\x0fnearest_by_join\x18/ \x01(\v2\x1c.spark.connect.NearestByJoinH\x00R\rnearestByJoin\x12&\n" +
	"\x03zip\x180 \x01(\v2\x12.spark.connect.ZipH\x00R\x03zip\x120\n" +
	...
	"\x05right\x18\x02 \x01(\v2\x17.spark.connect.RelationR\x05right\x12@\n" +
	"\x0ejoin_condition\x18\x03 \x01(\v2\x19.spark.connect.ExpressionR\rjoinCondition\x129\n" +
	"\tjoin_type\x18\x04 \x01(\x0e2\x1c.spark.connect.Join.JoinTypeR\bjoinType\"\xa5\x02\n" +
	"\rNearestByJoin\x12+\n" +
	"\x04left\x18\x01 \x01(\v2\x17.spark.connect.RelationR\x04left\x12-\n" +
	"\x05right\x18\x02 \x01(\v2\x17.spark.connect.RelationR\x05right\x12H\n" +
	"\x12ranking_expression\x18\x03 \x01(\v2\x19.spark.connect.ExpressionR\x11rankingExpression\x12\x1f\n" +
	"\vnum_results\x18\x04 \x01(\x05R\n" +
	"numResults\x12\x1b\n" +
	"\tjoin_type\x18\x05 \x01(\tR\bjoinType\x12\x12\n" +
	"\x04mode\x18\x06 \x01(\tR\x04mode\x12\x1c\n" +
	"\tdirection\x18\a \x01(\tR\tdirection\"a\n" +
	"\x03Zip\x12+\n" +
	"\x04left\x18\x01 \x01(\v2\x17.spark.connect.RelationR\x04left\x12-\n" +
	"\x05right\x18\x02 \x01(\v2\x17.spark.connect.RelationR\x05rightB6\n" +
...
var file_spark_connect_relations_proto_msgTypes = make([]protoimpl.MessageInfo, 85)
var file_spark_connect_relations_proto_goTypes = []any{
	...
	(*NearestByJoin)(nil),                        // 68: spark.connect.NearestByJoin
	(*Zip)(nil),                                  // 69: spark.connect.Zip
	(*MlRelation_Transform)(nil),                 // 70: spark.connect.MlRelation.Transform
	(*Fetch_Method)(nil),                         // 71: spark.connect.Fetch.Method
	(*Fetch_Method_Args)(nil),                    // 72: spark.connect.Fetch.Method.Args
	nil,                                          // 73: spark.connect.SQL.ArgsEntry
	nil,                                          // 74: spark.connect.SQL.NamedArgumentsEntry
	(*Read_NamedTable)(nil),                      // 75: spark.connect.Read.NamedTable
	(*Read_DataSource)(nil),                      // 76: spark.connect.Read.DataSource
	nil,                                          // 77: spark.connect.Read.NamedTable.OptionsEntry
	nil,                                          // 78: spark.connect.Read.DataSource.OptionsEntry
	nil,                                          // 79: spark.connect.RelationChanges.OptionsEntry
	(*Join_JoinDataType)(nil),                    // 80: spark.connect.Join.JoinDataType
	(*Aggregate_Pivot)(nil),                      // 81: spark.connect.Aggregate.Pivot
	(*Aggregate_GroupingSets)(nil),               // 82: spark.connect.Aggregate.GroupingSets
	(*StatSampleBy_Fraction)(nil),                // 83: spark.connect.StatSampleBy.Fraction
	(*NAReplace_Replacement)(nil),                // 84: spark.connect.NAReplace.Replacement
	nil,                                          // 85: spark.connect.WithColumnsRenamed.RenameColumnsMapEntry
	(*WithColumnsRenamed_Rename)(nil),            // 86: spark.connect.WithColumnsRenamed.Rename
	(*Unpivot_Values)(nil),                       // 87: spark.connect.Unpivot.Values
	nil,                                          // 88: spark.connect.Parse.OptionsEntry
	(*Catalog)(nil),                              // 89: spark.connect.Catalog
	(*anypb.Any)(nil),                            // 90: google.protobuf.Any
	(*ObjectRef)(nil),                            // 91: spark.connect.ObjectRef
	(*Origin)(nil),                               // 92: spark.connect.Origin
	(*Expression_Literal)(nil),                   // 93: spark.connect.Expression.Literal
	(*Expression)(nil),                           // 94: spark.connect.Expression
	(*Expression_SortOrder)(nil),                 // 95: spark.connect.Expression.SortOrder
	(*Expression_Alias)(nil),                     // 96: spark.connect.Expression.Alias
	(*DataType)(nil),                             // 97: spark.connect.DataType
	(*CommonInlineUserDefinedFunction)(nil),      // 98: spark.connect.CommonInlineUserDefinedFunction
	(*MlOperator)(nil),                           // 99: spark.connect.MlOperator
	(*MlParams)(nil),                             // 100: spark.connect.MlParams
}
var file_spark_connect_relations_proto_depIdxs = []int32{
	...
	68,  // 46: spark.connect.Relation.nearest_by_join:type_name -> spark.connect.NearestByJoin
	69,  // 47: spark.connect.Relation.zip:type_name -> spark.connect.Zip
	42,  // 48: spark.connect.Relation.fill_na:type_name -> spark.connect.NAFill
	43,  // 49: spark.connect.Relation.drop_na:type_name -> spark.connect.NADrop
	44,  // 50: spark.connect.Relation.replace:type_name -> spark.connect.NAReplace
	34,  // 51: spark.connect.Relation.summary:type_name -> spark.connect.StatSummary
	36,  // 52: spark.connect.Relation.crosstab:type_name -> spark.connect.StatCrosstab
	35,  // 53: spark.connect.Relation.describe:type_name -> spark.connect.StatDescribe
	37,  // 54: spark.connect.Relation.cov:type_name -> spark.connect.StatCov
	38,  // 55: spark.connect.Relation.corr:type_name -> spark.connect.StatCorr
	39,  // 56: spark.connect.Relation.approx_quantile:type_name -> spark.connect.StatApproxQuantile
	40,  // 57: spark.connect.Relation.freq_items:type_name -> spark.connect.StatFreqItems
	41,  // 58: spark.connect.Relation.sample_by:type_name -> spark.connect.StatSampleBy
	89,  // 59: spark.connect.Relation.catalog:type_name -> spark.connect.Catalog
	5,   // 60: spark.connect.Relation.ml_relation:type_name -> spark.connect.MlRelation
	90,  // 61: spark.connect.Relation.extension:type_name -> google.protobuf.Any
	7,   // 62: spark.connect.Relation.unknown:type_name -> spark.connect.Unknown
	70,  // 63: spark.connect.MlRelation.transform:type_name -> spark.connect.MlRelation.Transform
	6,   // 64: spark.connect.MlRelation.fetch:type_name -> spark.connect.Fetch
	4,   // 65: spark.connect.MlRelation.model_summary_dataset:type_name -> spark.connect.Relation
	91,  // 66: spark.connect.Fetch.obj_ref:type_name -> spark.connect.ObjectRef
	71,  // 67: spark.connect.Fetch.methods:type_name -> spark.connect.Fetch.Method
	92,  // 68: spark.connect.RelationCommon.origin:type_name -> spark.connect.Origin
	73,  // 69: spark.connect.SQL.args:type_name -> spark.connect.SQL.ArgsEntry
	93,  // 70: spark.connect.SQL.pos_args:type_name -> spark.connect.Expression.Literal
	74,  // 71: spark.connect.SQL.named_arguments:type_name -> spark.connect.SQL.NamedArgumentsEntry
	94,  // 72: spark.connect.SQL.pos_arguments:type_name -> spark.connect.Expression
	4,   // 73: spark.connect.WithRelations.root:type_name -> spark.connect.Relation
	4,   // 74: spark.connect.WithRelations.references:type_name -> spark.connect.Relation
	75,  // 75: spark.connect.Read.named_table:type_name -> spark.connect.Read.NamedTable
	76,  // 76: spark.connect.Read.data_source:type_name -> spark.connect.Read.DataSource
	79,  // 77: spark.connect.RelationChanges.options:type_name -> spark.connect.RelationChanges.OptionsEntry
	4,   // 78: spark.connect.Project.input:type_name -> spark.connect.Relation
	94,  // 79: spark.connect.Project.expressions:type_name -> spark.connect.Expression
	4,   // 80: spark.connect.Filter.input:type_name -> spark.connect.Relation
	94,  // 81: spark.connect.Filter.condition:type_name -> spark.connect.Expression
	4,   // 82: spark.connect.Join.left:type_name -> spark.connect.Relation
	4,   // 83: spark.connect.Join.right:type_name -> spark.connect.Relation
	94,  // 84: spark.connect.Join.join_condition:type_name -> spark.connect.Expression
	0,   // 85: spark.connect.Join.join_type:type_name -> spark.connect.Join.JoinType
	80,  // 86: spark.connect.Join.join_data_type:type_name -> spark.connect.Join.JoinDataType
	4,   // 87: spark.connect.SetOperation.left_input:type_name -> spark.connect.Relation
	4,   // 88: spark.connect.SetOperation.right_input:type_name -> spark.connect.Relation
	1,   // 89: spark.connect.SetOperation.set_op_type:type_name -> spark.connect.SetOperation.SetOpType
	4,   // 90: spark.connect.Limit.input:type_name -> spark.connect.Relation
	4,   // 91: spark.connect.Offset.input:type_name -> spark.connect.Relation
	4,   // 92: spark.connect.Tail.input:type_name -> spark.connect.Relation
	4,   // 93: spark.connect.Aggregate.input:type_name -> spark.connect.Relation
	2,   // 94: spark.connect.Aggregate.group_type:type_name -> spark.connect.Aggregate.GroupType
	94,  // 95: spark.connect.Aggregate.grouping_expressions:type_name -> spark.connect.Expression
	94,  // 96: spark.connect.Aggregate.aggregate_expressions:type_name -> spark.connect.Expression
	81,  // 97: spark.connect.Aggregate.pivot:type_name -> spark.connect.Aggregate.Pivot
	82,  // 98: spark.connect.Aggregate.grouping_sets:type_name -> spark.connect.Aggregate.GroupingSets
	4,   // 99: spark.connect.Sort.input:type_name -> spark.connect.Relation
	95,  // 100: spark.connect.Sort.order:type_name -> spark.connect.Expression.SortOrder
	4,   // 101: spark.connect.Drop.input:type_name -> spark.connect.Relation
	94,  // 102: spark.connect.Drop.columns:type_name -> spark.connect.Expression
	4,   // 103: spark.connect.Deduplicate.input:type_name -> spark.connect.Relation
	4,   // 104: spark.connect.Sample.input:type_name -> spark.connect.Relation
	4,   // 105: spark.connect.SubqueryAlias.input:type_name -> spark.connect.Relation
	4,   // 106: spark.connect.Repartition.input:type_name -> spark.connect.Relation
	4,   // 107: spark.connect.ShowString.input:type_name -> spark.connect.Relation
	4,   // 108: spark.connect.HtmlString.input:type_name -> spark.connect.Relation
	4,   // 109: spark.connect.StatSummary.input:type_name -> spark.connect.Relation
	4,   // 110: spark.connect.StatDescribe.input:type_name -> spark.connect.Relation
	4,   // 111: spark.connect.StatCrosstab.input:type_name -> spark.connect.Relation
	4,   // 112: spark.connect.StatCov.input:type_name -> spark.connect.Relation
	4,   // 113: spark.connect.StatCorr.input:type_name -> spark.connect.Relation
	4,   // 114: spark.connect.StatApproxQuantile.input:type_name -> spark.connect.Relation
	4,   // 115: spark.connect.StatFreqItems.input:type_name -> spark.connect.Relation
	4,   // 116: spark.connect.StatSampleBy.input:type_name -> spark.connect.Relation
	94,  // 117: spark.connect.StatSampleBy.col:type_name -> spark.connect.Expression
	83,  // 118: spark.connect.StatSampleBy.fractions:type_name -> spark.connect.StatSampleBy.Fraction
	4,   // 119: spark.connect.NAFill.input:type_name -> spark.connect.Relation
	93,  // 120: spark.connect.NAFill.values:type_name -> spark.connect.Expression.Literal
	4,   // 121: spark.connect.NADrop.input:type_name -> spark.connect.Relation
	4,   // 122: spark.connect.NAReplace.input:type_name -> spark.connect.Relation
	84,  // 123: spark.connect.NAReplace.replacements:type_name -> spark.connect.NAReplace.Replacement
	4,   // 124: spark.connect.ToDF.input:type_name -> spark.connect.Relation
	4,   // 125: spark.connect.WithColumnsRenamed.input:type_name -> spark.connect.Relation
	85,  // 126: spark.connect.WithColumnsRenamed.rename_columns_map:type_name -> spark.connect.WithColumnsRenamed.RenameColumnsMapEntry
	86,  // 127: spark.connect.WithColumnsRenamed.renames:type_name -> spark.connect.WithColumnsRenamed.Rename
	4,   // 128: spark.connect.WithColumns.input:type_name -> spark.connect.Relation
	96,  // 129: spark.connect.WithColumns.aliases:type_name -> spark.connect.Expression.Alias
	4,   // 130: spark.connect.WithWatermark.input:type_name -> spark.connect.Relation
	4,   // 131: spark.connect.Hint.input:type_name -> spark.connect.Relation
	94,  // 132: spark.connect.Hint.parameters:type_name -> spark.connect.Expression
	4,   // 133: spark.connect.Unpivot.input:type_name -> spark.connect.Relation
	94,  // 134: spark.connect.Unpivot.ids:type_name -> spark.connect.Expression
	87,  // 135: spark.connect.Unpivot.values:type_name -> spark.connect.Unpivot.Values
	4,   // 136: spark.connect.Transpose.input:type_name -> spark.connect.Relation
	94,  // 137: spark.connect.Transpose.index_columns:type_name -> spark.connect.Expression
	94,  // 138: spark.connect.UnresolvedTableValuedFunction.arguments:type_name -> spark.connect.Expression
	4,   // 139: spark.connect.ToSchema.input:type_name -> spark.connect.Relation
	97,  // 140: spark.connect.ToSchema.schema:type_name -> spark.connect.DataType
	4,   // 141: spark.connect.RepartitionByExpression.input:type_name -> spark.connect.Relation
	94,  // 142: spark.connect.RepartitionByExpression.partition_exprs:type_name -> spark.connect.Expression
	4,   // 143: spark.connect.MapPartitions.input:type_name -> spark.connect.Relation
	98,  // 144: spark.connect.MapPartitions.func:type_name -> spark.connect.CommonInlineUserDefinedFunction
	4,   // 145: spark.connect.GroupMap.input:type_name -> spark.connect.Relation
	94,  // 146: spark.connect.GroupMap.grouping_expressions:type_name -> spark.connect.Expression
	98,  // 147: spark.connect.GroupMap.func:type_name -> spark.connect.CommonInlineUserDefinedFunction
	94,  // 148: spark.connect.GroupMap.sorting_expressions:type_name -> spark.connect.Expression
	4,   // 149: spark.connect.GroupMap.initial_input:type_name -> spark.connect.Relation
	94,  // 150: spark.connect.GroupMap.initial_grouping_expressions:type_name -> spark.connect.Expression
	97,  // 151: spark.connect.GroupMap.state_schema:type_name -> spark.connect.DataType
	57,  // 152: spark.connect.GroupMap.transform_with_state_info:type_name -> spark.connect.TransformWithStateInfo
	97,  // 153: spark.connect.TransformWithStateInfo.output_schema:type_name -> spark.connect.DataType
	4,   // 154: spark.connect.CoGroupMap.input:type_name -> spark.connect.Relation
	94,  // 155: spark.connect.CoGroupMap.input_grouping_expressions:type_name -> spark.connect.Expression
	4,   // 156: spark.connect.CoGroupMap.other:type_name -> spark.connect.Relation
	94,  // 157: spark.connect.CoGroupMap.other_grouping_expressions:type_name -> spark.connect.Expression
	98,  // 158: spark.connect.CoGroupMap.func:type_name -> spark.connect.CommonInlineUserDefinedFunction
	94,  // 159: spark.connect.CoGroupMap.input_sorting_expressions:type_name -> spark.connect.Expression
	94,  // 160: spark.connect.CoGroupMap.other_sorting_expressions:type_name -> spark.connect.Expression
	4,   // 161: spark.connect.ApplyInPandasWithState.input:type_name -> spark.connect.Relation
	94,  // 162: spark.connect.ApplyInPandasWithState.grouping_expressions:type_name -> spark.connect.Expression
	98,  // 163: spark.connect.ApplyInPandasWithState.func:type_name -> spark.connect.CommonInlineUserDefinedFunction
	94,  // 164: spark.connect.CommonInlineUserDefinedTableFunction.arguments:type_name -> spark.connect.Expression
	61,  // 165: spark.connect.CommonInlineUserDefinedTableFunction.python_udtf:type_name -> spark.connect.PythonUDTF
	97,  // 166: spark.connect.PythonUDTF.return_type:type_name -> spark.connect.DataType
	63,  // 167: spark.connect.CommonInlineUserDefinedDataSource.python_data_source:type_name -> spark.connect.PythonDataSource
	4,   // 168: spark.connect.CollectMetrics.input:type_name -> spark.connect.Relation
	94,  // 169: spark.connect.CollectMetrics.metrics:type_name -> spark.connect.Expression
	4,   // 170: spark.connect.Parse.input:type_name -> spark.connect.Relation
	3,   // 171: spark.connect.Parse.format:type_name -> spark.connect.Parse.ParseFormat
	97,  // 172: spark.connect.Parse.schema:type_name -> spark.connect.DataType
	88,  // 173: spark.connect.Parse.options:type_name -> spark.connect.Parse.OptionsEntry
	4,   // 174: spark.connect.AsOfJoin.left:type_name -> spark.connect.Relation
	4,   // 175: spark.connect.AsOfJoin.right:type_name -> spark.connect.Relation
	94,  // 176: spark.connect.AsOfJoin.left_as_of:type_name -> spark.connect.Expression
	94,  // 177: spark.connect.AsOfJoin.right_as_of:type_name -> spark.connect.Expression
	94,  // 178: spark.connect.AsOfJoin.join_expr:type_name -> spark.connect.Expression
	94,  // 179: spark.connect.AsOfJoin.tolerance:type_name -> spark.connect.Expression
	4,   // 180: spark.connect.LateralJoin.left:type_name -> spark.connect.Relation
	4,   // 181: spark.connect.LateralJoin.right:type_name -> spark.connect.Relation
	94,  // 182: spark.connect.LateralJoin.join_condition:type_name -> spark.connect.Expression
	0,   // 183: spark.connect.LateralJoin.join_type:type_name -> spark.connect.Join.JoinType
	4,   // 184: spark.connect.NearestByJoin.left:type_name -> spark.connect.Relation
	4,   // 185: spark.connect.NearestByJoin.right:type_name -> spark.connect.Relation
	94,  // 186: spark.connect.NearestByJoin.ranking_expression:type_name -> spark.connect.Expression
	4,   // 187: spark.connect.Zip.left:type_name -> spark.connect.Relation
	4,   // 188: spark.connect.Zip.right:type_name -> spark.connect.Relation
	91,  // 189: spark.connect.MlRelation.Transform.obj_ref:type_name -> spark.connect.ObjectRef
	99,  // 190: spark.connect.MlRelation.Transform.transformer:type_name -> spark.connect.MlOperator
	4,   // 191: spark.connect.MlRelation.Transform.input:type_name -> spark.connect.Relation
	100, // 192: spark.connect.MlRelation.Transform.params:type_name -> spark.connect.MlParams
	72,  // 193: spark.connect.Fetch.Method.args:type_name -> spark.connect.Fetch.Method.Args
	93,  // 194: spark.connect.Fetch.Method.Args.param:type_name -> spark.connect.Expression.Literal
	4,   // 195: spark.connect.Fetch.Method.Args.input:type_name -> spark.connect.Relation
	93,  // 196: spark.connect.SQL.ArgsEntry.value:type_name -> spark.connect.Expression.Literal
	94,  // 197: spark.connect.SQL.NamedArgumentsEntry.value:type_name -> spark.connect.Expression
	77,  // 198: spark.connect.Read.NamedTable.options:type_name -> spark.connect.Read.NamedTable.OptionsEntry
	78,  // 199: spark.connect.Read.DataSource.options:type_name -> spark.connect.Read.DataSource.OptionsEntry
	94,  // 200: spark.connect.Aggregate.Pivot.col:type_name -> spark.connect.Expression
	93,  // 201: spark.connect.Aggregate.Pivot.values:type_name -> spark.connect.Expression.Literal
	94,  // 202: spark.connect.Aggregate.GroupingSets.grouping_set:type_name -> spark.connect.Expression
	93,  // 203: spark.connect.StatSampleBy.Fraction.stratum:type_name -> spark.connect.Expression.Literal
	93,  // 204: spark.connect.NAReplace.Replacement.old_value:type_name -> spark.connect.Expression.Literal
	93,  // 205: spark.connect.NAReplace.Replacement.new_value:type_name -> spark.connect.Expression.Literal
	94,  // 206: spark.connect.Unpivot.Values.values:type_name -> spark.connect.Expression
...
func file_spark_connect_relations_proto_init() {
	...
	file_spark_connect_relations_proto_msgTypes[68].OneofWrappers = []any{
		(*Fetch_Method_Args_Param)(nil),
		(*Fetch_Method_Args_Input)(nil),
	}
	file_spark_connect_relations_proto_msgTypes[72].OneofWrappers = []any{}
	type x struct{}
