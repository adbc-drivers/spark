...
import (
	...
	"github.com/adbc-drivers/spark/go/connectclient/internal/generated"
...
func (t *TestExecutor) ExecuteCommand(ctx context.Context, plan *generated.Plan) (arrow.Table, *types.StructType, map[string]any, error) {
	if t.Err != nil {
...
func (t *TestExecutor) ReleaseSession(ctx context.Context) error {
	return errors.New("not implemented")
}
