...
import (
	...
	"github.com/adbc-drivers/spark/go/connectclient/client/base"

	"github.com/adbc-drivers/spark/go/connectclient/client/options"
...
func (rs *retryState) nextAttempt(p RetryPolicy) *time.Duration {
	...
	rs.retryCount++
	wait := rs.nextWait
	rs.nextWait = min(time.Duration(float32(rs.nextWait.Milliseconds())*p.BackoffMultiplier)*time.Millisecond, p.MaxBackoff)
...
type rpcType interface {
	*proto.AnalyzePlanResponse | *proto.ConfigResponse | *proto.ArtifactStatusesResponse |
		...
		*proto.CloneSessionResponse | *proto.GetStatusResponse
}
...
func (r *retriableSparkConnectClient) CloneSession(ctx context.Context,
	in *proto.CloneSessionRequest, opts ...grpc.CallOption,
) (*proto.CloneSessionResponse, error) {
	return wrapRetriableCall(ctx, r.retryPolicies, func(ctx2 context.Context) (*proto.CloneSessionResponse, error) {
		return r.client.CloneSession(ctx2, in, opts...)
	})
}

func (r *retriableSparkConnectClient) GetStatus(ctx context.Context,
	in *proto.GetStatusRequest, opts ...grpc.CallOption,
) (*proto.GetStatusResponse, error) {
	return wrapRetriableCall(ctx, r.retryPolicies, func(ctx2 context.Context) (*proto.GetStatusResponse, error) {
		return r.client.GetStatus(ctx2, in, opts...)
	})
}
