...
the [Security
Policy](https://github.com/adbc-drivers/spark?tab=security-ov-file#readme).
...
You will also need to set up an Apache Spark instance. This can be done with
Docker Compose:
