...
var drv = driver.NewDriver(mallocator.NewMallocator())
...
//export SparkDriverInit
func SparkDriverInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
